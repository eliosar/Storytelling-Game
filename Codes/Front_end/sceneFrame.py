...
def start(scene_name: str):
    ...
    for choice in choices:
        ...
        choices_next_scene_name.append(manager.join_paths(('/scene', choice["scenename"])))
    ...
    data = (scene_name, background_64, choices_as_str, choices_next_scene_name, texts_as_str, speekers)
